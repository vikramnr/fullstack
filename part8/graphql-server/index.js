...
const MONGODB_URI =
  "mongodb+srv://fullstackgraph:l2r0cvNNFsXEprwT@maincluster.iwdbn.mongodb.net/<dbname>?retryWrites=true&w=majority";
...
const typeDefs = gql`
  ...
  type Mutation {
    ...
    editAuthor(name: String, setBornTo: Float): Authors
  }
